...
namespace CherryMP
{
    ...
    {
        public static string GTANFolder = (string)Registry.GetValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Rockstar Games\Grand Theft Auto V", "CherryMPInstallDir", null);
        ...
        public void Start(params string[] args)
        {
            ...
            */
            ...
            if (GTANFolder != AppDomain.CurrentDomain.BaseDirectory)
            {
                try
                {
                    Registry.SetValue(dictPath, "CherryMPInstallDir", AppDomain.CurrentDomain.BaseDirectory);
                }
            ...
            {
                MessageBox.Show(splashScreen.SplashScreen, "GTA5 or the Cherry Multiplayer is already running. Please close them before starting Simple Native Multiplayer.");
                return;
            }
            #endregion
            ...
            try
            {
                ...
                if (File.Exists(GTANFolder + "\\OpenIV.asi"))
                {
                    File.Copy(GTANFolder + "\\OpenIV.asi", settings.GamePath + "\\OpenIV.asi");
                }
                ...
                /*MessageBox.Show(splashScreen.SplashScreen, "Лаунчер начинает обрабатывать RPF файлы. Это займёт некоторое время.\nНАЖМИТЕ ОК", "Внимание");
                // create mods folders
                if (!Directory.Exists(settings.GamePath + "\\mods")) Directory.CreateDirectory(settings.GamePath + "\\mods");
                if (!Directory.Exists(settings.GamePath + "\\mods\\update")) Directory.CreateDirectory(settings.GamePath + "\\mods\\update");
                if (!Directory.Exists(settings.GamePath + "\\mods\\x64")) Directory.CreateDirectory(settings.GamePath + "\\mods\\x64");
                if (!Directory.Exists(settings.GamePath + "\\mods\\x64\\dlcpacks")) Directory.CreateDirectory(settings.GamePath + "\\mods\\x64\\dlcpacks");

                if (!Directory.Exists(settings.GamePath + "\\ELS")) Directory.CreateDirectory(settings.GamePath + "\\ELS");
                if (!Directory.Exists(settings.GamePath + "\\ELS\\pack_default")) Directory.CreateDirectory(settings.GamePath + "\\ELS\\pack_default");

                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\pol718")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\pol718");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg");
                if (!Directory.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees")) Directory.CreateDirectory(settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees");

                splashScreen.SetPercent(50);

                // ELS car copy
                if (File.Exists(GTANFolder + "mods\\ELS\\pack_default\\VLCG.xml") && !File.Exists(settings.GamePath + "\\ELS\\pack_default\\VLCG.xml"))
                {
                    File.Copy(GTANFolder + "mods\\ELS\\pack_default\\VLCG.xml", settings.GamePath + "\\ELS\\pack_default\\VLCG.xml");
                }
                splashScreen.SetPercent(55);
                // caravantaxi copy
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\caravantaxi\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\caravantaxi\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi\\dlc.rpf");
                }
                splashScreen.SetPercent(60);
                // pol718
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\pol718\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\pol718\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\pol718\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\pol718\\dlc.rpf");
                }
                splashScreen.SetPercent(65);
                // polamggtr
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\polamggtr\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\polamggtr\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr\\dlc.rpf");
                }
                splashScreen.SetPercent(70);
                // polgt500
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\polgt500\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\polgt500\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500\\dlc.rpf");
                }
                splashScreen.SetPercent(75);
                // priustaxi
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\priustaxi\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\priustaxi\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi\\dlc.rpf");
                }
                splashScreen.SetPercent(80);
                // vlcg
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\vlcg\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\vlcg\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg\\dlc.rpf");
                }
                // aesthetictrees
                if (File.Exists(GTANFolder + "mods\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf") && !File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf", settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf");
                }
                ...
                if (File.Exists(GTANFolder + "mods\\update\\update.rpf") && !File.Exists(settings.GamePath + "\\" + "mods" + "\\" + "update" + "\\" + "update.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\update\\update.rpf", settings.GamePath + "\\" + "mods" + "\\" + "update" + "\\" + "update.rpf");
                }

                /*if (File.Exists(GTANFolder + "mods\\x64e.rpf"))
                {
                    File.Copy(GTANFolder + "mods\\x64e.rpf", settings.GamePath + "\\" + "mods" + "\\" + "x64e.rpf");
                }*/
            ...
            try
            {
                ...
                // ELS car copy
                /*if (File.Exists(settings.GamePath + "\\ELS\\pack_default\\VLCG.xml"))
                {
                    File.Delete(settings.GamePath + "\\ELS\\pack_default\\VLCG.xml");
                }
                // caravantaxi delete
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\caravantaxi\\dlc.rpf");
                }
                // pol718 delete
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\pol718\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\pol718\\dlc.rpf");
                }
                // polamggtr
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\polamggtr\\dlc.rpf");
                }
                // polgt500
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\polgt500\\dlc.rpf");
                }
                // priustaxi
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\priustaxi\\dlc.rpf");
                }
                // vlcg
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\vlcg\\dlc.rpf");
                }
                // aesthetictrees
                if (File.Exists(settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf"))
                {
                    File.Delete(settings.GamePath + "\\update\\x64\\dlcpacks\\aesthetictrees\\dlc.rpf");
                }*/
                ...
                if (File.Exists(settings.GamePath + "\\" + "mods" + "\\" + "update" + "\\" + "update.rpf"))
                {
                    File.Delete(settings.GamePath + "\\mods\\update\\update.rpf");
                }

                /*if (File.Exists(settings.GamePath + "\\" + "mods" + "\\" + "x64e.rpf"))
                {
                    File.Delete(settings.GamePath + "\\" + "mods" + "\\" + "x64e.rpf");
                }*/
        ...
        public static void InjectOurselves(Process gta)
        {
            ...
            foreach (var file in Directory.GetFiles(GTANFolder + "bin", "*.asi"))
            {
                ...
                //if (Path.GetFileName(file).ToLower().StartsWith("LowPriorityPropRestore")) continue;
                //if (Path.GetFileName(file).ToLower().StartsWith("NoMoSloMo")) continue;
                //if (Path.GetFileName(file).ToLower().StartsWith("HeliCam")) continue;
                //if (Path.GetFileName(file).ToLower().StartsWith("DoPedStuff")) continue;
                //if (Path.GetFileName(file).ToLower().StartsWith("OpenInteriors")) continue;
                //if (Path.GetFileName(file).ToLower().StartsWith("OpenIV")) continue;
