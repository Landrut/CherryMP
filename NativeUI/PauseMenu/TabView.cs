...
namespace NativeUI.PauseMenu
{
    public class TabView
    {
        ...
        public void Update()
        {
            ...
            if (!HideTabs)
            {
                new UIResText(Title, new Point(safe.X, safe.Y - 80), 1.10f, Color.White, Font.ChaletComprimeCologne,
                ...
                new UIResText(Name, new Point((int) res.Width - safe.X - 70, safe.Y - 95), 0.43f, Color.White,
                ...
                new UIResText(t, new Point((int) res.Width - safe.X - 70, safe.Y - 60), 0.43f, Color.White,
                    Font.ChaletComprimeCologne, UIResText.Alignment.Right)
                {
                    DropShadow = true,
                }.Draw();
                ...
                new UIResText(subt, new Point((int) res.Width - safe.X - 70, safe.Y - 40), 0.43f, Color.White,
                    Font.ChaletComprimeCologne, UIResText.Alignment.Right)
                {
                    DropShadow = true,
                }.Draw();
                ...
                for (int i = 0; i < Tabs.Count; i++)
                {
                    ...
                    new UIResText(Tabs[i].Title.ToUpper(), safe.AddPoints(new Point((tabWidth/2) + (tabWidth + 5)*i, 5)),
                        0.45f,
                        Tabs[i].Active ? Color.Black : Color.White, Font.ChaletComprimeCologne, UIResText.Alignment.Centered)
                        .Draw();

                    if (Tabs[i].Active)
                    {
                        new UIResRectangle(safe.SubtractPoints(new Point(-((tabWidth + 5)*i), 10)),
                            new Size(tabWidth, 10), Color.DarkRed).Draw();
                    }
