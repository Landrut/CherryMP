...
namespace NativeUI.PauseMenu
{
    public class TabTextItem : TabItem
    {
        ...
        public override void Draw()
        {
            ...
            {
                new UIResText(TextTitle, SafeSize.AddPoints(new Point(40, 20)), 1.25f, Color.FromArgb(alpha, Color.White)).Draw();
            }
            ...
            if (!string.IsNullOrEmpty(Text))
            {
                ...
                new UIResText(Text, SafeSize.AddPoints(new Point(40, 150)), 0.43f, Color.FromArgb(alpha, Color.White))
                {
