...
namespace NativeUI
{
    public abstract class TimerBarBase
    {
        ...
        public virtual void Draw(int interval, Size offset)
        {
            ...
            new UIResText(Label, new Point((int)res.Width - safe.X - 180, (int)res.Height - safe.Y - (30 + (interval))), 0.45f, Color.White, Font.ChaletComprimeCologne, UIResText.Alignment.Right).Draw();
