...
namespace CherryMP.Misc
{
    ...
    {
        public static bool IsWeaponAutomatic(CherryMPShared.WeaponHash hash)
        {
            switch (hash)
            {
                default:
                    return true;
                case CherryMPShared.WeaponHash.Molotov:
                case CherryMPShared.WeaponHash.BZGas:
                case CherryMPShared.WeaponHash.SmokeGrenade:
                case CherryMPShared.WeaponHash.ProximityMine:
                case CherryMPShared.WeaponHash.StickyBomb:
                case CherryMPShared.WeaponHash.Grenade:
                case CherryMPShared.WeaponHash.Flare:
                case CherryMPShared.WeaponHash.Snowball:
                case CherryMPShared.WeaponHash.Ball:
                case CherryMPShared.WeaponHash.Pipebomb:

                case CherryMPShared.WeaponHash.RPG:
                case CherryMPShared.WeaponHash.HomingLauncher:
                case CherryMPShared.WeaponHash.Railgun:
                case CherryMPShared.WeaponHash.GrenadeLauncher:
                case CherryMPShared.WeaponHash.Firework:
                case CherryMPShared.WeaponHash.Musket:
                case CherryMPShared.WeaponHash.FlareGun:
                case CherryMPShared.WeaponHash.CompactLauncher:
        ...
        public static bool NeedsFakeBullets(int wephash)
        {
            ...
            switch ((CherryMPShared.WeaponHash) uW)
            {
                default:
                    return false;
                case CherryMPShared.WeaponHash.Molotov:
