...
namespace CherryMP.Networking
{
    internal class StreamerThread : Script
    {
        ...
        bool isInRange(CherryMPShared.Vector3 Center, CherryMPShared.Vector3 Dest, float Range)
        {
    ...
    internal class Streamer
    {
        ...
        public void UpdateInterpolations()
        {
            ...
            foreach (var ent in ents)
            {
                if (ent.PositionMovement != null)
                {
                    ...
                    ent.Position = CherryMPShared.Vector3.Lerp(ent.PositionMovement.StartVector,
                ...
                if (ent.RotationMovement != null)
                {
                    ...
                    ent.Rotation = CherryMPShared.Vector3.Lerp(ent.RotationMovement.StartVector,
        ...
        public RemoteVehicle CreateVehicle(int model, CherryMPShared.Vector3 position, CherryMPShared.Vector3 rotation, int netHash)
        {
            short vehComp = ~0;
        ...
        public RemoteBlip CreateBlip(CherryMPShared.Vector3 pos, int netHandle)
        {
            RemoteBlip rem;
            lock (ClientMap)
            {
        ...
        public void CreateMarker(int type, CherryMPShared.Vector3 position, CherryMPShared.Vector3 rotation, CherryMPShared.Vector3 dir, CherryMPShared.Vector3 scale, int r, int g, int b, int a,
            int netHandle)
        {
            lock (ClientMap)
            {
        ...
        public int CreateLocalVehicle(int model, CherryMPShared.Vector3 pos, float heading)
        {
            var veh = CreateVehicle(model, pos, new CherryMPShared.Vector3(0, 0, heading), --_localHandleCounter);
            veh.LocalOnly = true;
        ...
        public int CreateLocalBlip(CherryMPShared.Vector3 pos)
        {
        ...
        public int CreateLocalPed(int model, CherryMPShared.Vector3 pos, float heading)
        {
            ...
            pp.Alpha = 255;
            pp.ModelHash = model;
            pp.Rotation = new CherryMPShared.Vector3(0, 0, heading);
            pp.Dimension = 0;
        ...
        private void StreamInParticle(RemoteParticle data)
        {
            ...
            Function.Call(Hash.USE_PARTICLE_FX_ASSET, data.Library);
