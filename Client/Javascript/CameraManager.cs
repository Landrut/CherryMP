...
namespace CherryMP.Javascript
{
    ...
    {
        internal CherryMPShared.Vector3 Position { get; set; }
        internal CherryMPShared.Vector3 Rotation { get; set; }

        internal int EntityPointing { get; set; }
        internal int BonePointing { get; set; }
        internal CherryMPShared.Vector3 PointOffset { get; set; }
        internal CherryMPShared.Vector3 VectorPointing { get; set; }

        internal int EntityAttached { get; set; }
        internal int BoneAttached { get; set; }
        internal CherryMPShared.Vector3 AttachOffset { get; set; }
