...
namespace CherryMPShared
{
    ...
    public class VehicleProperties : EntityProperties
    {
        public VehicleProperties()
        {
            ...
            EntityType = (byte)CherryMPShared.EntityType.Vehicle;
        }
    ...
    public class BlipProperties : EntityProperties
    {
        ...
        {
            EntityType = (byte)CherryMPShared.EntityType.Blip;
        }
    ...
    public class MarkerProperties : EntityProperties
    {
        ...
        {
            EntityType = (byte)CherryMPShared.EntityType.Marker;
        }
    ...
    public class PickupProperties : EntityProperties
    {
        ...
        {
            EntityType = (byte)CherryMPShared.EntityType.Pickup;
        }
    ...
    public class PlayerProperties : EntityProperties
    {
        public PlayerProperties()
        {
            ...
            EntityType = (byte)CherryMPShared.EntityType.Player;
