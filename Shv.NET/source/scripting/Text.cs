...
namespace GTA.UI
{
	...
	public class Text : IElement
	{
		...
		public Text(string caption, PointF position, float scale) : this(caption, position, scale, Color.WhiteSmoke, Font.ChaletComprimeCologne, Alignment.Left, false, false, 1.0f)
		{
		}
		/// <summary>
		/// Initializes a new instance of the <see cref="Text"/> class used for drawing text on the screen.
		...
		public Text(string caption, PointF position, float scale, Color color) : this(caption, position, scale, color, Font.ChaletComprimeCologne, Alignment.Left, false, false, 1.0f)
		{
		}
		/// <summary>
		/// Initializes a new instance of the <see cref="Text"/> class used for drawing text on the screen.
		...
		/// </returns>
		public static float GetStringWidth(string text, Font font = Font.ChaletComprimeCologne, float scale = 1.0f)
		{
		...
		/// </returns>
		public static float GetScaledStringWidth(string text, Font font = Font.ChaletComprimeCologne, float scale = 1.0f)
		{
			Function.Call(Hash._BEGIN_TEXT_COMMAND_WIDTH, "CELL_EMAIL_BCON");
