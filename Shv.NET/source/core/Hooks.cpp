...
char *__fastcall GetGameText(__int64 a1, BYTE *a2, __int64 a3)
{
	if (strcmp((const char*)a2, "LOADING_SPLAYER_L") == 0)
		return (char*)"Loading Cherry Multiplayer...";
	else if (strcmp((const char*)a2, "LEGAL_MAIN_CLOUD_USAGE") == 0)
		return (char*)"Cherry Multiplayer is in no way affiliated with Rockstar Games, Rockstar North.";
	else if (strcmp((const char*)a2, "LEGAL_MAIN_DISK_USAGE") == 0)
		return (char*)"Cherry Multiplayer is loading...";
	else if (strcmp((const char*)a2, "LEGAL_MAIN_LOADING_USAGE") == 0)
		return (char*)"Cherry Multiplayer is a GTA V alternative multiplayer maintained by Landrut";
